    ...
    <>
      <div className='min-w-full grid md:grid-cols-5 md:px-10 gap-4 bg-black'>
        <div className='bg-slate-950 shadow-sm p-4 flex flex-col items-center justify-center'>
          ...
          <div className='mt-10'>
            <h1 className='flex justify-start p-2 py-1  bg-slate-900 shadow-md shadow-gray-950 text-[#0f0] text-2xl my-1 rounded-md hover:text-[#0ff] font-bold' onClick={message}>Description</h1>
            <h1 className='flex justify-start p-2 py-1  bg-slate-900 shadow-md shadow-gray-950 text-[#0f0] text-2xl my-1 rounded-md hover:text-[#0ff] font-bold' onClick={message}>Skill</h1>
            <h1 className='flex justify-start p-2 py-1  bg-slate-900 shadow-md shadow-gray-950 text-[#0f0] text-2xl my-1 rounded-md hover:text-[#0ff] font-bold' onClick={message}>Contact</h1>
            <h1 className='flex justify-start p-2 py-1  bg-slate-900 shadow-md shadow-gray-950 text-[#0f0] text-2xl my-1 rounded-md hover:text-[#0ff] font-bold' onClick={message}>Projects</h1>
          </div>
        ...
        <div className='md:col-span-4 text-[#0f0] p-4 grid md:grid-rows-10 gap-5'>
          ...
          <div className='row-span-9 grid grid-cols-2 gap-5'>
            <div className='flex flex-col items-center justify-center md:px-2'>
              <p className='text-[#0f0] hover:text-[#0ff] transition-colors duration-900'>A motivated student with expertise in Problem Solving and Logic 
...
Algorithms along with positive attitude and Critical Thinking.
              ...
              <p className='text-[#0f0] hover:text-[#0ff] transition-colors duration-900 hidden md:block'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas neque assumenda quasi sit</p>
